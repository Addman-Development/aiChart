...
function SlackCallback() {
  ...
  const _onConnectSlack = async () => {
    ...
    await response.json();
    toast.success("Successfully added Edison to your Slack workspace");
    setLoading(false);
  };
  ...
  return (
    <div>
      <div className="text-lg font-semibold font-tw">
        Add Edison to your Slack workspace
      </div>
      <div className="text-sm text-foreground-500">
        {"Add Edison to your Slack workspace to start using it"}
      </div>
      ...
      <div className="bg-content1 p-4 rounded-lg border border-divider">
        {loading && (
          <div className="flex flex-col items-center justify-center gap-2">
            ...
            <div className="text-center">
              Please wait while we are adding Edison to your Slack workspace...
            </div>
          </div>
        )}
        ...
        {!error && !loading && (
          <div className="flex flex-col items-center justify-center gap-2">
            ...
            <div className="text-center font-bold">
              Successfully added Edison to your Slack workspace
            </div>
            <div className="text-center">
              DM Edison in Slack to get started and finish the setup:
            </div>
            <div className="text-center">
        ...
        {error && (
          <Alert
            color="danger"
            variant="flat"
            title="Failed to add Edison to your Slack workspace"
