        ...
        <div className="flex flex-col gap-2">
          <div className="flex flex-row items-center justify-between">
            <div className="flex flex-col gap-1">
              ...
              <div className="text-sm text-foreground-500">
                When enabled, Edison can be used in all channels. When disabled, only selected channels are allowed.
              </div>
            </div>
            <Switch
        ...
        {!allowAllChannels && (
          <div className="flex flex-col gap-2">
            ...
            <Select
              ...
              variant="bordered"
              description="Edison can only be used in these channels. To see private channels in the list, add the app to the channel in Slack first."
